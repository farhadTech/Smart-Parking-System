...
const UserLocationsPage = () => {
  ...
  const [ selectedLocation, setSelectedLocation ] =
    useState<ParkingLocation>( parkingLocations[ 0 ] );
      ...
      <div className={ pageStyle }>
        ...
        <section className="grid gap-6 xl:grid-cols-[1.5fr_1fr]">
          ...
          <div className="space-y-6">
            ...
            <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
              <div className={ `${ cardStyle } p-5` }>
                <p className={ `text-sm ${ mutedTextStyle }` }>Locations</p>
          ...
          <div className="space-y-5">
            {/* Search */ }
            <div className={ `${ cardStyle } flex items-center gap-3 px-4 py-3` }>
              <Search
                size={ 18 }
                ...
                return (
                  ...
                  >
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <span
                        className={ `rounded-full border px-3 py-1 text-xs font-bold ${ heatClass[ location.heatLevel ]
                          }` }
                      >
                        { location.heatLevel }
                      </span>
